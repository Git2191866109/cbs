    ...
    $(document).ready(function(){
      jQuery("#memberList").jqGrid({
        ...
        colNames: [
          ...
          "<msg:message code='member.emailAccount'/>",
        ...
        colModel: [
          ...
          {name:'emailAccount',index:'emailAccount',width:'15%',align:'center',hidden: false,sortable:false},
          {name:'nickname',index:'nickname',width:'10%',align:'center',hidden: false,sortable:false},
          {name:'male',index:'male',width:'10%',align:'center',hidden: false,sortable:false,formatter:function(cellvalue, options, rowObject){
            if(cellvalue == "0"){
              return "男";
            }else if(cellvalue == "1"){
              return "女";
          ...
          {name:'registerTime',index:'registerTime',width:'20%',align:'center',hidden: false,sortable:false},
          {name:'isActivate',index:'isActivate',width:'10',align:'center',hidden: false,sortable:false,formatter:function(cellvalue, options, rowObject){
            if(cellvalue == "0"){
              return "禁用";
            }else if(cellvalue == "1"){
              return "启用";
