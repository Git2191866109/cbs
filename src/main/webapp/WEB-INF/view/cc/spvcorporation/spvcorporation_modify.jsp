		...
		$.ajaxFileUpload({
			...
			success: function (data, status){
				...
				if(data.state == 'SUCCESS'){
					var src =  "http://res.xuefeibang.com/" + data.url;
					$imgInput.val(src);
...
<body>
<form:form method="post" action="${base}/form/submit/spvCorporation/modify" commandName="spvCorporation" name="spvCorporation">
...
<input type="hidden" name="buttonGroup" value="${cc_spvcorporation_spvcorporation_modify_code},<msg:message code='button.continue.modify'/>"/>
<input type="hidden" name="replace_message_element_name" value="code"/>
<form:hidden path="id" />
<!-- 银行名称 -->
<input type="hidden" name="bankName" id="bankName" value="${spvCorporation.bankName}"/>
<div class="form-body">
	...
	<div class="form-content">
		   ...
		   <li>
				...
				<div class="form-field-title">
					...
					<c:if test="${spvCorporation.type == 1}">
					<div class="form-field-elt">
						<input type="radio" name="type" checked="checked"  value="1" >spv
					</div>
				</c:if>
				<c:if test="${spvCorporation.type == 2}">
					<div class="form-field-elt">
						<input type="radio" name="type" checked="checked"  value="2" >平台
					</div>
				</c:if>
				<div class="form-field-prompt">
					...
					<div class="modal-body upload-box">
						<div class="upload-header">
							...
							<input type="file" name="imgfileInput" id="imgfileInput" class="imgfileInput"  accept=".jpg,.png,.gif" style="display: none;" >
								<%--<input type="hidden" class="imgInput" name="signaturePicPath" style="" id="imgInput" >--%>
							<form:hidden path="signaturePicPath" class="dfinput imgInput"/>
						</div>
						<div class="upload-body" style="height: 100px;width: 100px;">
							<img src="${spvCorporation.signaturePicPath}" id="img_Box" class="img_Box" style="width:100%;"/>
