...
<form:form method="post" action="${base}/form/submit/member/modify" commandName="member" name="member">
	...
	<input type="hidden" name="viewCode" value="${cc_member_account_modify_code}"/>
	...
	<input type="hidden" name="buttonGroup" value="${cc_member_account_modify_code},<msg:message code='button.continue.modify'/>"/>
<form:hidden path="id" />
<div class="form-body">
