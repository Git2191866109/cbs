...
<input type="hidden" name="buttonGroup" value="${pc_productmanager_product_newplayerproduct_modify_code},<msg:message code='button.continue.modify'/>"/>
<form:hidden path="id" />
	...
	<div class="form-content">
		<ul style="overflow-y:auto;height:100%;width:100%">
			...
			<li>
				...
				<div class="form-field-elt">
					<form:input path="totalAmount" class="dfinput" readonly="${product.status != 1}"/>
				</div>
				<div class="form-field-prompt">
			...
			<%--<li>--%>
				...
				<%--</div>--%>
				<%--<div class="form-field-elt">--%>
					<%--<form:input path="surplusAmount" class="dfinput" readonly="true" />--%>
				<%--</div>--%>
				<%--<div class="form-field-prompt">--%>
