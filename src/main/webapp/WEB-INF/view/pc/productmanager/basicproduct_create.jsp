...
<body>
<form:form method="post" action="${base}/form/submit/basicProduct/create" commandName="basicProduct" name="basicProduct">
...
<input type="hidden" name="buttonGroup" value="${pc_productmanager_basicproduct_create_code},<msg:message code='button.continue.create'/>"/>
...
<div class="form-body">
	...
	<div class="form-content">
		<ul style="overflow-y:auto;height:100%;width:100%">
			...
			<li>
				<div class="form-field-title">
					<msg:message code='basicProduct.interestRateDate'/>
				</div>
				<div class="form-field-elt">
			...
			<li>
				<div class="form-field-title">
					<msg:message code='basicProduct.profitExpirationDate'/>
				</div>
				<div class="form-field-elt">
			...
			<li>
				<div class="form-field-title">
					<msg:message code='basicProduct.actualExpirationDate'/>
				</div>
				<div class="form-field-elt">
			...
			<li>
				<div class="form-field-title">
					<msg:message code='basicProduct.paymentDate'/>
				</div>
				<div class="form-field-elt">
			...
			<li>
				<div class="form-field-title">
					<msg:message code='basicProduct.actualPaymentDate'/>
				</div>
				<div class="form-field-elt">
			...
			<li>
				<div class="form-field-title">
					<msg:message code='basicProduct.expectedProfitRatio'/>
				</div>
				<div class="form-field-elt">
			...
			<li>
				<div class="form-field-title">
					<msg:message code='basicProduct.actualExpectedProfitRatio'/>
				</div>
				<div class="form-field-elt">
			...
			<li>
				<div class="form-field-title">
					<msg:message code='basicProduct.expectedProfit'/>
				</div>
				<div class="form-field-elt">
			...
			<li>
				<div class="form-field-title">
					<msg:message code='basicProduct.actualProfit'/>
				</div>
				<div class="form-field-elt">
