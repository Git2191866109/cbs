		...
		<ul style="overflow-y:auto;height:100%;width:100%">
			<li>
				<div class="form-field-title">
					<b>*</b><msg:message code='withdrawCashRecords.name'/>
				</div>
			...
			<li>
				<div class="form-field-title">
					<b>*</b><msg:message code='withdrawCashRecords.code'/>
				</div>
				<div class="form-field-elt">
			...
			<li>
				<div class="form-field-title">
					<b>*</b><msg:message code='withdrawCashRecords.category'/>
				</div>
				<div class="form-field-elt">
			...
			<li>
				<div class="form-field-title">
					<b>*</b><msg:message code='withdrawCashRecords.isFixed'/>
				</div>
				<div class="form-field-elt">
			...
			<li>
				<div class="form-field-title">
					<b>*</b><msg:message code='withdrawCashRecords.isInherit'/>
				</div>
				<div class="form-field-elt">
			...
			<li>
				<div class="form-field-title">
					<msg:message code='withdrawCashRecords.description'/>
				</div>
				<div class="form-field-elt">
