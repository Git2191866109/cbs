...
<body>
<form:form method="post" action="${base}/form/submit/category/create" commandName="category" name="category">
...
<input type="hidden" name="buttonGroup" value="${pc_basecfg_category_create_code},<msg:message code='button.continue.create'/>"/>
