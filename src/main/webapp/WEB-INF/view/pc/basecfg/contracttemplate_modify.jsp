...
<body>
<form:form method="post" action="${base}/form/submit/contractTemplate/modifyComplete" commandName="contractTemplate" name="contractTemplate" >
<input type="hidden" name="isLog" value="1"/>
<input type="hidden" name="viewCode" value="${pc_basecfg_contracttemplate_code}"/>
<input type="hidden" name="replaceName" value="name"/>
<input type="hidden" name="buttonGroup" value="${pc_basecfg_contracttemplate_code},<msg:message code='button.back.list'/>"/>
<input type="hidden" name="buttonGroup" value="${pc_basecfg_contracttemplate_modify_code},<msg:message code='button.continue.modify'/>"/>
<form:hidden path="id" />
...
<div class="form-body">
		...
		<ul style="overflow-y:auto;height:100%;width:100%">
			<li>
				<div class="form-field-title">
					<b>*</b><msg:message code='contractTemplate.name'/>
				</div>
			...
			<li>
				<div class="form-field-title">
					<b>*</b><msg:message code='contractTemplate.code'/>
				</div>
				<div class="form-field-elt">
			...
			<li>
				<div class="form-field-title">
					<msg:message code='contractTemplate.templateContent'/>
				</div>
				<div class="form-field-elt">
	...
	<div class="form-footer">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="button" onclick="window.location.href='${base}/history/back/${pc_basecfg_contracttemplate_code}'" class="btn-80" value="<msg:message code='button.back'/>"/>
	</div>
</div>
</form:form>
</body>	
