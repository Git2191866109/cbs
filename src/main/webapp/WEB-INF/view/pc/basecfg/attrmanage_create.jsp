...
<body>
<form:form method="post" action="${base}/form/submit/attribute/create" commandName="attribute" name="attribute">
...
<input type="hidden" name="buttonGroup" value="${pc_basecfg_attrmanage_create_code},<msg:message code='button.continue.create'/>"/>
