...
<body>
<form:form method="post" action="${base}/form/submit/contractTemplate/create" commandName="contractTemplate" name="contractTemplate">
...
<input type="hidden" name="buttonGroup" value="${pc_basecfg_contracttemplate_create_code},<msg:message code='button.continue.create'/>"/>
