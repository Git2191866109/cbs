    ...
    jQuery("#growStagesList").jqGrid({
    	...
    	loadComplete:function(){
    	    ...
    	    $(".shortcut_modify").click(function(){
    			...
    			window.location.href="${base}/goto/growStages/jumpModify?viewCode=${eb_budget_grow_modify_code}&isContextCode=1&id="+rowid;
    	    });    
    	    </shiro:hasPermission>
		/* 	<shiro:hasPermission name="${eb_budget_grow_delete_code}">
    	    $(".shortcut_delete").click(function(){
    			...
    			var layers = top.layer.confirm("<msg:message code='system.prompt.delete.confirm'/>",  function(){
    				var url = "${base}/ajax/submit/growStages/delete.json?isLog=1&replaceName="+data.name+"&id=" + rowid ;
    				$.ajax({
    					url:url,
    					type:'post',
    					timeout:'60000',
		    ...
		    $("#top_create","#t_growStagesList").click(function(){
		    	window.location.href = "${base}/goto/growStages/jumpCreate?viewCode=${eb_budget_grow_create_code}&isContextCode=1";
		    });    
		    </shiro:hasPermission>			
    	},
