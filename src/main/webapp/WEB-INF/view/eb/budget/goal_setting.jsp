...
<body>
<form:form method="post" action="${base}/form/submit/educationGoal/setting" commandName="educationGoal" name="educationGoal" id="educationGoalForm">
...
<input type="hidden" name="buttonGroup" value="${eb_budget_goal_setting_code},<msg:message code='button.continue.modify'/>"/>
<form:hidden path="id" />
