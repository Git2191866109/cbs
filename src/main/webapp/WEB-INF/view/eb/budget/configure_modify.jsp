...
<body>
<form:form method="post" action="${base}/form/submit/educationConfigure/modify/${eb_budget_configure_modify_code}" commandName="educationConfigure" name="educationConfigure">
<div class="form-body">
	...
	<div class="form-footer">
		...
		&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="button" onclick="window.location.href='${base}/history/back/${eb_budget_configure_code}'" class="btn-80" value="<msg:message code='button.back'/>"/>
	</div>
</div>
</form:form>
</body>	
