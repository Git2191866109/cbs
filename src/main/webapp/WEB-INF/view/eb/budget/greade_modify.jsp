...
<body>
<form:form method="post" action="${base}/form/submit/greadeYear/modify" commandName="greadeYear" name="greadeYear">
<form:hidden path="id" />
...
<input type="hidden" name="buttonGroup" value="${eb_budget_greade_modify_code},<msg:message code='button.continue.modify'/>"/>
<div class="form-body">
