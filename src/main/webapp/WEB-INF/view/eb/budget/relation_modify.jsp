...
<body>
<form:form method="post" action="${base}/form/submit/modeItemRelation/modify/${eb_budget_relation_modify_code}" commandName="modeItemRelation" name="modeItemRelation">
<div class="form-body">
