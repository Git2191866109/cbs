...
<body>
<form:form method="post" action="${base}/form/submit/educationMode/create" commandName="educationMode" name="educationMode">
...
<input type="hidden" name="buttonGroup" value="${eb_budget_mode_create_code},<msg:message code='button.continue.create'/>"/>

<form:hidden path="growStagesId" />
<div class="form-body">
