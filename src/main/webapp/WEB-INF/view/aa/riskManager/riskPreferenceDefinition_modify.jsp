...
<body>
<form:form method="post" action="${base}/form/submit/riskPreferenceDefinition/modify" commandName="riskPreferenceDefinition" name="riskPreferenceDefinition">
...
<input type="hidden" name="buttonGroup" value="${aa_riskManager_riskPreferenceDefinition_modify_code},<msg:message code='button.continue.modify'/>"/>
	<form:hidden path="id" />
	<div class="form-body">
