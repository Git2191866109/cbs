...
<body>
<form:form method="post" action="${base}/form/submit/assetCategory/modify" commandName="assetCategory" name="assetCategory" >
...
<input type="hidden" name="buttonGroup" value="${aa_assetManage_assetCategory_modify_code},<msg:message code='button.continue.modify'/>"/>
<form:hidden path="id" />
<div class="form-body">
	...
	<div class="form-content">
		<ul style="overflow-y:auto;height:100%;width:100%">
			...
			<li>
				<div class="form-field-title">
					<b>*</b><msg:message code='assetCategory.variance'/>
				</div>
				<div class="form-field-elt">
