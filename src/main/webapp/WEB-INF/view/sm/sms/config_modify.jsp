...
<body>
<form:form method="post" id="form" action="${base}/form/submit/serviceProvider/modify" commandName="serviceProvider" name="serviceProvider">
...
<input type="hidden" name="buttonGroup" value="${sm_sms_config_modify_code},<msg:message code='button.continue.modify'/>"/>
