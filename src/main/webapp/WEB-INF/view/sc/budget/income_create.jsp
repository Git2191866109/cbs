...
<body>
<form:form method="post" action="${base}/form/submit/residentIncomes/create/${sc_budget_income_code}" commandName="residentIncomes" name="residentIncomes">
<div class="form-body">
		...
		<ul style="overflow-y:auto;height:100%;width:100%">
	        ...
	        <li>
				...
				<div class="form-field-elt">
					...
					<input type="radio" name="isBaseData" value="1" style="margin-left: 50px;" checked/>是
				</div>
				<div class="form-field-prompt">
