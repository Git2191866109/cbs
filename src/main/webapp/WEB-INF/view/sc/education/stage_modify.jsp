...
<body>
<form:form method="post" action="${base}/form/submit/educationStage/modify/${sc_education_stage_code}" commandName="educationStage" name="educationStage">
<form:hidden path="id" />
<div class="form-body">
		...
		<ul style="overflow-y:auto;height:100%;width:100%">
	        <li>
				<div class="form-field-title">
					<b>*</b><msg:message code='educationStage.name'/>
				</div>
