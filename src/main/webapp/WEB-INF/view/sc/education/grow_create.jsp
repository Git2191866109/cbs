...
<body>
<form:form method="post" action="${base}/form/submit/growStages/create/${sc_education_grow_code}" commandName="growStages" name="growStages">
<div class="form-body">
	...
	<div class="form-content">
		<ul style="overflow-y:auto;height:100%;width:100%">
	        ...
	        <li>
				<div class="form-field-title">
					<b>*</b><msg:message code='growStages.startAge'/>
				</div>
				<div class="form-field-elt">
					<form:input path="startAge" class="dfinput"/>
				</div>
				<div class="form-field-prompt">
					<form:errors path="startAge" delimiter=" "></form:errors>
				</div>
			</li>
	        <li>
				<div class="form-field-title">
					<b>*</b><msg:message code='growStages.endAge'/>
				</div>
				<div class="form-field-elt">
					<form:input path="endAge" class="dfinput"/>
				</div>
				<div class="form-field-prompt">
					<form:errors path="endAge" delimiter=" "></form:errors>
				</div>
			</li>
			<li>
