...
<body>
<form:form method="post" action="${base}/form/submit/viewConfiguration/modify/${sc_view_table_column_modify_code}" commandName="viewConfiguration" name="viewConfiguration">
<div class="form-body">
