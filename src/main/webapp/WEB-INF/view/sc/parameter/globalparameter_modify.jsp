...
<body>
<form:form method="post" action="${base}/form/submit/parameter/modify" commandName="parameter" name="parameter">
	<input type="hidden" name="isLog" value="1"/>
	<input type="hidden" name="viewCode" value="${sc_parameter_globalparameter_code}"/>
	...
	<input type="hidden" name="buttonGroup" value="${sc_parameter_globalparameter_modify_code},<msg:message code='button.continue.modify'/>"/>
	<form:hidden path="id" />
	<div class="form-body">
