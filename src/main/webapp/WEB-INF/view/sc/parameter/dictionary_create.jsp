...
<body>
<form:form id="dictionary" method="post" action="${base}/form/submit/dictionary/create" commandName="dictionary" name="dictionary">
	...
	<input type="hidden" name="buttonGroup" value="${sc_parameter_dictionary_create_code},<msg:message code='button.continue.create'/>"/>
	<div class="form-body">
