...
<body>
<form:form id="dictionaryCategory" method="post" action="${base}/form/submit/dictionaryCategory/create" commandName="dictionaryCategory" name="dictionaryCategory">
	<input type="hidden" name="isLog" value="1"/>
	<input type="hidden" name="type" value="1"/>
	<input type="hidden" name="viewCode" value="${sc_parameter_dictionarycategory_code}"/>
	...
	<input type="hidden" name="buttonGroup" value="${sc_parameter_dictionarycategory_create_code},<msg:message code='button.continue.create'/>"/>
	<div class="form-body">
