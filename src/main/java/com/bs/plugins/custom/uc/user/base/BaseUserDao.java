...
public interface BaseUserDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectUserOrganization(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectUserUserRoleRelation(T entity) throws Exception;
}
