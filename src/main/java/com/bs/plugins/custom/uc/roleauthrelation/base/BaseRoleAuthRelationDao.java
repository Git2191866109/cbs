...
public interface BaseRoleAuthRelationDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	 ...
	 * @return list
	 */
	public List<T> selectRoleAuthRelationRole(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectRoleAuthRelationAuthorization(T entity) throws Exception;
