...
public interface BaseRoleDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectRoleRoleAuthRelation(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectRoleUserRoleRelation(T entity) throws Exception;
}
