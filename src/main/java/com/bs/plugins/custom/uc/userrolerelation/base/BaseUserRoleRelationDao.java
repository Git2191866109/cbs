...
public interface BaseUserRoleRelationDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	 ...
	 * @return list
	 */
	public List<T> selectUserRoleRelationRole(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectUserRoleRelationUser(T entity) throws Exception;
