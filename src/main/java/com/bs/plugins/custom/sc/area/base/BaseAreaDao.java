...
public interface BaseAreaDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectAreaSchool(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectAreaResidentIncomes(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectAreaBudgetItemData(T entity) throws Exception;
}
