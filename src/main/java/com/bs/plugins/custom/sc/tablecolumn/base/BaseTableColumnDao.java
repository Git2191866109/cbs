...
public interface BaseTableColumnDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectTableColumnTable(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectTableColumnTableIndex(T entity) throws Exception;
}
