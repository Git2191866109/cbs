...
public interface BaseSubscriptionDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectSubscriptionProductAmountLock(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectSubscriptionSpvCorporation(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectSubscriptionLoan(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectSubscriptionProduct(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectSubscriptionSubscriptionContract(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectSubscriptionProductReturnMoney(T entity) throws Exception;
}
