...
public interface BaseProductReturnMoneyDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectProductReturnMoneySpvCorporation(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectProductReturnMoneySubscription(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectProductReturnMoneyProduct(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectProductReturnMoneyPlatformServiceFee(T entity) throws Exception;
}
