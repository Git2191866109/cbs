...
public interface BaseLoanDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectLoanProduct(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectLoanSubscription(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectLoanPlatformServiceFee(T entity) throws Exception;
}
