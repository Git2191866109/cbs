...
public interface BaseSpvProductReturnMoneyDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectSpvProductReturnMoneySpvCorporation(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectSpvProductReturnMoneyMember(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectSpvProductReturnMoneyProduct(T entity) throws Exception;
