...
public interface BaseAppointmentDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectAppointmentMember(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectAppointmentProduct(T entity) throws Exception;
