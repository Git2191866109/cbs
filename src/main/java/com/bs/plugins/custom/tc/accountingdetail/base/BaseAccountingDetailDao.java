...
public interface BaseAccountingDetailDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectAccountingDetailMember(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectAccountingDetailProduct(T entity) throws Exception;
