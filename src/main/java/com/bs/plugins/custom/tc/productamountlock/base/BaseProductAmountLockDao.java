...
public interface BaseProductAmountLockDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectProductAmountLockMember(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectProductAmountLockProduct(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectProductAmountLockSubscription(T entity) throws Exception;
}
