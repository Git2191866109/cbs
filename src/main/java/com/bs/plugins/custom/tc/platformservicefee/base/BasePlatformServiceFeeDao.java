...
public interface BasePlatformServiceFeeDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectPlatformServiceFeeProductReturnMoney(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectPlatformServiceFeeLoan(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectPlatformServiceFeeProduct(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectPlatformServiceFeeSpvCorporation(T entity) throws Exception;
