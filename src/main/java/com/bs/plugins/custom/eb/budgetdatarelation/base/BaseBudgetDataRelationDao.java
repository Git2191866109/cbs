...
public interface BaseBudgetDataRelationDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	 ...
	 * @return list
	 */
	public List<T> selectBudgetDataRelationItemFieldValue(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectBudgetDataRelationBudgetItem(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectBudgetDataRelationEducationMode(T entity) throws Exception;
