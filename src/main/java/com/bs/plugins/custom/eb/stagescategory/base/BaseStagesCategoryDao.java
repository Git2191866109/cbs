...
public interface BaseStagesCategoryDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	 ...
	 * @return list
	 */
	public List<T> selectStagesCategoryGrowStages(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectStagesCategoryBudgetDataRelation(T entity) throws Exception;
}
