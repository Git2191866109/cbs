...
public interface BaseBudgetItemDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectBudgetItemBudgetCategory(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectBudgetItemModeItemRelation(T entity) throws Exception;
}
