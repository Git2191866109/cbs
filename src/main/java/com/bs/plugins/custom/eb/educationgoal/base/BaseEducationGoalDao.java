...
public interface BaseEducationGoalDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectEducationGoalBudgetBasicInfo(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectEducationGoalGoalItemRelation(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectEducationGoalEducationConfigure(T entity) throws Exception;
}
