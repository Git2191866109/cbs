...
public interface BaseBudgetItemDataDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectBudgetItemDataArea(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectBudgetItemDataModeItemRelation(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectBudgetItemDataBudgetItemDataCollection(T entity) throws Exception;
}
