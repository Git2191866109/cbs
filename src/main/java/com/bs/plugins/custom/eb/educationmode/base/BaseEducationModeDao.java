...
public interface BaseEducationModeDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectEducationModeGrowStages(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectEducationModeModeItemRelation(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectEducationModeGoalItemRelation(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectEducationModeBudgetSelection(T entity) throws Exception;
}
