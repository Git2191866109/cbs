...
public interface BaseGoalBudgetRelationDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	 ...
	 * @return list
	 */
	public List<T> selectGoalBudgetRelationEducationGoal(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectGoalBudgetRelationGrowStages(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectGoalBudgetRelationBudgetCategory(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectGoalBudgetRelationBudgetItem(T entity) throws Exception;
