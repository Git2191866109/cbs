...
public interface BaseBudgetBasicInfoDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectBudgetBasicInfoMember(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectBudgetBasicInfoEducationGoal(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectBudgetBasicInfoBudgetSelection(T entity) throws Exception;
}
