...
public interface BaseGoalItemRelationDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectGoalItemRelationEducationGoal(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectGoalItemRelationGrowStages(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectGoalItemRelationEducationMode(T entity) throws Exception;
