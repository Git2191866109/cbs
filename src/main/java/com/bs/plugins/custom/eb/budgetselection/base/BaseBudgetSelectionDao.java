...
public interface BaseBudgetSelectionDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectBudgetSelectionBudgetBasicInfo(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectBudgetSelectionGrowStages(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectBudgetSelectionEducationMode(T entity) throws Exception;
