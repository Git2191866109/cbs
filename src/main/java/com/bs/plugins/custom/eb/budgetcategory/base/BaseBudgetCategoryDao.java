...
public interface BaseBudgetCategoryDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectBudgetCategoryBudgetItem(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectBudgetCategoryItemField(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectBudgetCategoryModeItemRelation(T entity) throws Exception;
}
