...
public interface BaseBudgetItemDataCollectionDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectBudgetItemDataCollectionBudgetItemData(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectBudgetItemDataCollectionItemFieldValue(T entity) throws Exception;
}
