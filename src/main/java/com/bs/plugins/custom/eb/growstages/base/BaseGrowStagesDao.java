...
public interface BaseGrowStagesDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectGrowStagesGoalItemRelation(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectGrowStagesEducationMode(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectGrowStagesModeItemRelation(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectGrowStagesGreadeYear(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectGrowStagesBudgetSelection(T entity) throws Exception;
}
