...
public interface BaseItemFieldValueDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectItemFieldValueItemField(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectItemFieldValueBudgetItemDataCollection(T entity) throws Exception;
