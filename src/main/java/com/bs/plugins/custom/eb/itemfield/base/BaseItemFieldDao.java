...
public interface BaseItemFieldDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectItemFieldBudgetCategory(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectItemFieldItemFieldValue(T entity) throws Exception;
}
