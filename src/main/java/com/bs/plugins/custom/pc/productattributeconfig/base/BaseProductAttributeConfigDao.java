...
public interface BaseProductAttributeConfigDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectProductAttributeConfigAttribute(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectProductAttributeConfigProduct(T entity) throws Exception;
