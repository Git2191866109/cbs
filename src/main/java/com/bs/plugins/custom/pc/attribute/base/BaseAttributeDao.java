...
public interface BaseAttributeDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectAttributeStructureConfig(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectAttributeAttributeDataConfig(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectAttributeProductAttributeConfig(T entity) throws Exception;
}
