...
public interface BaseStructureConfigDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectStructureConfigCategory(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectStructureConfigAttribute(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectStructureConfigStructureRuleRelation(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectStructureConfigStructureKindRelation(T entity) throws Exception;
}
