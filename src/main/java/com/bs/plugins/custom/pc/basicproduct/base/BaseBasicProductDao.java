...
public interface BaseBasicProductDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectBasicProductSpvCorporation(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectBasicProductProduct(T entity) throws Exception;
}
