...
public interface BaseProductContractDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	...
	*/
	 ...
	 * @return list
	 */
	public List<T> selectProductContractProduct(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectProductContractContractTemplate(T entity) throws Exception;
