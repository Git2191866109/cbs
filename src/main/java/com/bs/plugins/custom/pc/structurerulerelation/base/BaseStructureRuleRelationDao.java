...
public interface BaseStructureRuleRelationDao<T extends Entity>{
	/**
	 * 数据库插入
	 * 
	 * @param sqlid
	 ...
	 * @return list
	 */
	public List<T> selectStructureRuleRelationStructureConfig(T entity) throws Exception;
	 ...
	 * @return list
	 */
	public List<T> selectStructureRuleRelationValidationRule(T entity) throws Exception;
